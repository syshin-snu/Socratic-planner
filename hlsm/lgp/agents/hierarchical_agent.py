...
from lgp.env.alfred.segmentation_definitions import OBJECT_STR_TO_INT, OBJECT_INT_TO_STR
...
class HierarchicalAgent(Agent):
    ...
    def act(self, observation: Observation, hl_action):
        self.is_failed = False
        ...
        while True:
            if self.current_skill is None:
                hl_action: Subgoal = self.hl_agent.act(self.state_repr, hl_action)
