...
class ActionProposalAgent(Agent):
    ...
    def _select_action(self, state_repr : StateRepr, hl_action):
    ...
    def act(self, observation_or_state: Union[Observation, StateRepr], hl_action) -> Action:
        ...
        action = self._select_action(s_0, hl_action)
